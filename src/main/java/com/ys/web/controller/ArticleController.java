...
public class ArticleController {
    ...
    @PreAuthorize("hasAnyRole('USER','OPERATOR','ADMIN')")
    private ModelAndView create(@ModelAttribute @Valid Article article, BindingResult bindingResult, ModelAndView modelAndView, @AuthenticationPrincipal Principal principal) {
