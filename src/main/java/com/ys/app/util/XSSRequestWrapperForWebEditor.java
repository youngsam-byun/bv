...
public class XSSRequestWrapperForWebEditor extends HttpServletRequestWrapper {

	public XSSRequestWrapperForWebEditor(HttpServletRequest request) {
		super(request);
	}
	...
	private String stripXSS(String value) {
		...
		if (value != null) {
			...
			// Avoid anything in a href='*.js' type of expression
			scriptPattern = Pattern.compile("a href=\"(.*?)\".js",
					Pattern.CASE_INSENSITIVE | Pattern.MULTILINE | Pattern.DOTALL);
			value = scriptPattern.matcher(value).replaceAll("");
			...
			// Avoid anything in a lonesome :// , < , > , " , / , \ type of
			// characters
